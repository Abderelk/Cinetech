                    ...
                    <nav >
                        <ul className='flex flex-row items-center'>
                            <li className='px-3 text-sm'>
                                <Link className='flex text-center hover:border-b-2 border-red ' to="/"><FaHome className='text-xl mr-2' />Accueil</Link>
                            </li>
                            <li className=' px-3  text-sm'>
                                <Link className='flex text-center  hover:border-b-2 border-red' to="/mes-favoris"> <FaRegStar className="text-xl mr-2" />Mes favoris</Link>
                            </li>
                            <li className='px-3 text-sm'>
                                <Link className=' flex text-center hover:border-b-2 border-red' to="/deja-vues"><FaRegEye className="text-xl mr-2" />Déjà vues</Link>
                            </li>
                            <li className='px-3 text-sm'>
                                <Link className=' flex text-center hover:border-b-2 border-red ' to="/a-voir"><FaHourglassStart className="text-xl mr-2" />À voir</Link>
                            </li>
                        </ul>
                    </nav>
                )}
